...
Each of these lists all the relevant effects. The names of these effects is importaint and should remain unchanged unless you will also be modifying the configuration of the uvex instrument.
