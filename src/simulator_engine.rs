...
pub fn pipline(hallucinate_data:bool){
    ...
    let name3 = hallucinate::name_gen(LINE_SIZE, NUM_LINES, "C_bytes");
    ...
    if hallucinate_data {
        ...
        hallucinate::byte_version(LINE_SIZE, NUM_LINES, name3.as_str()).expect("TODO: panic message");
    }
    ...
    let final_vec: Vec<f64> = data1
        ...
        .zip(data2.par_iter())
        .zip(data3.par_iter())
        .map(|((data_point1,data_point2),data_point3)| data_point1+data_point2+data_point3).collect();
